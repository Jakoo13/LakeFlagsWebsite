...
const data = {
  ...
  title: 'Making Life Easier Achieved with Design',
  features: [
    {
      id: 1,
      ...
      text:
        'This app has been designed specifically to simplify the process of keeping track who\'s up next on the water',
    },
    {
      id: 2,
      ...
      title: 'Communication',
      text:
        'We wanted the ability for one house to message another house. Communication is the bridge between confusion and clarity.',
    },
  ],
};
